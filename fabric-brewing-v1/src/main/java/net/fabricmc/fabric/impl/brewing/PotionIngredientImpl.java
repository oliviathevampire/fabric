...
public class PotionIngredientImpl implements PotionIngredient {
    ...
    public Ingredient asIngredient() {
        return this.isIngredient() ? delegate : Ingredient.ofStacks(PotionUtil.setPotion(new ItemStack(Items.POTION), potion)); }
    ...
    public boolean test(ItemStack stack) {
		return this.isIngredient() ? delegate.test(stack) :
			PotionUtil.getPotion(stack) == potion && stack.getItem() == PotionTypeRegistry.INSTANCE.getItem(getPotionType());
    }
