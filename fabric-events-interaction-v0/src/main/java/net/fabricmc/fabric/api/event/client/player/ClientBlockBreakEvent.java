...
public final class ClientBlockBreakEvent {
	...
	public interface OnStart {
		 ...
		 */
		boolean onBlockBreakStart(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state, float progress);
	}
	...
	public interface OnProgress {
		 ...
		 * @return {@code false} to cancel block placing action, or {@code true} to pass to next listener
		 */
		boolean onBlockBreakProgress(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state, float progress);
	}
	...
	public interface OnBreak {
		 ...
		 */
		void onBlockBreak(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state, float progress);
	}
	...
	public interface OnCancel {
		 ...
		 */
		void onBlockBreakCancel(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state, float progress);
	}
}
