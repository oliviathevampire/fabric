...
public final class ClientBlockPlaceEvent {
	...
	public interface Before {
		 ...
		 */
		boolean beforeBlockPlace(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state);
	}
	...
	public interface After {
		 ...
		 */
		void afterBlockPlace(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state);
	}
	...
	public interface Canceled {
		 ...
		 */
		void onBlockPlaceCanceled(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state);
	}
}
