...
import net.fabricmc.fabric.api.networking.player.tracking.v1.PlayerTracking;
 ...
 *
 * @deprecated Please use {@link PlayerTracking} instead.
 */
@Deprecated
public final class PlayerStream {
	...
	public static Stream<PlayerEntity> watching(World world, ChunkPos pos) {
		if (world instanceof ServerWorld) {
			...
			return (Stream) PlayerTracking.tracking((ServerWorld) world, pos);
		}
	...
	public static Stream<PlayerEntity> watching(Entity entity) {
		//noinspection unchecked,rawtypes
		return (Stream) PlayerTracking.tracking(entity);
	}
